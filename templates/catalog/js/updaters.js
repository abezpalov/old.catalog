$("body").delegate("[data-do*='switch-item-state']", "click", function(){
...
$("body").delegate("[data-do*='edit-item']", "click", function(){
...
$("body").delegate("[data-do*='edit-item-save']", "click", function(){
...
$("body").delegate("[data-do*='edit-item-cancel']", "click", function(){
	$('#EditItemModal').foundation('reveal', 'close');
	return false;
});