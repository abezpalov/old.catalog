...
urlpatterns = patterns('',
	...
	url(r'^products/c/(?P<category>[0-9]+)-(?P<childs>[yn]{1})/(?P<vendor>[a-zA-Z0-9_-]+)/search/(?P<search>[\S\s]+)/$', views.products, name='products'),
	url(r'^products/c/(?P<category>[0-9]+)-(?P<childs>[yn]{1})/(?P<vendor>[a-zA-Z0-9_-]+)/search/(?P<search>[\S\s]+)/page/(?P<page>[0-9]+)/$', views.products, name='products'),
	# TODO ex: /catalog/products/c/456-y/search/vfy-rx300/
	url(r'^products/c/(?P<category>[0-9]+)-(?P<childs>[yn]{1})/search/(?P<search>[\S\s]+)/$', views.products, name='products'),
	url(r'^products/c/(?P<category>[0-9]+)-(?P<childs>[yn]{1})/search/(?P<search>[\S\s]+)/page/(?P<page>[0-9]+)/$', views.products, name='products'),
	# TODO ex: /catalog/products/fujitsu/search/vfy-rx300/
	url(r'^products/(?P<vendor>[a-zA-Z0-9_-]+)/search/(?P<search>[\S\s]+)/$', views.products, name='products'),
	url(r'^products/(?P<vendor>[a-zA-Z0-9_-]+)/search/(?P<search>[\S\s]+)/page/(?P<page>[0-9]+)/$', views.products, name='products'),
	# TODO ex: /catalog/products/search/vfy-rx300/
	url(r'^products/search/(?P<search>[\S\s]+)/$', views.products, name='products'),
	url(r'^products/search/(?P<search>[\S\s]+)/page/(?P<page>[0-9]+)/$', views.products, name='products'),
